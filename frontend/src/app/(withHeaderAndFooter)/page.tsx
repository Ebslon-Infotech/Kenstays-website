...
import oceanOverlay from "@/assets/Homepage/Gallery/denys-nevozhai-guNIjIuUcgY-unsplash.jpg";
...
export default function page() {
  return (
    <>
      ...
      {/* Offers */}
      <div className="my-16 p-10 bg-cover bg-center bg-fixed" style={{ backgroundImage: `url(${oceanOverlay.src})` }}>
        <div className="bg-white/95 p-10 rounded-lg"><OffersSection /></div>
      </div>

      {/* Trending Cities */}
      <div className="p-10 bg-cover bg-center bg-fixed" style={{ backgroundImage: `url(${oceanOverlay.src})` }}>
        <div className="max-w-7xl mx-auto bg-white/95 p-10 rounded-lg">
          <h1
          ...
          <div className="container my-10">
            <div className="grid grid-cols-4 gap-6 h-[600px]">
              ...
              <div className="col-span-3 relative">
                ...
                />
                <div 
                  className="text-white text-center font-medium absolute bottom-0 w-full py-3 bg-cover bg-center"
                  style={{ backgroundImage: `url(${oceanOverlay.src})`, backgroundBlendMode: 'overlay', backgroundColor: 'rgba(0, 150, 136, 0.7)' }}
                >
                  Singapore
                </div>
              </div>
          ...
          <div className="container my-10">
            <div className="grid grid-cols-4 gap-6 h-[600px]">
              ...
              <div className="col-span-1 row-span-2 relative">
                ...
                />
                <div 
                  className="text-white text-center font-medium absolute bottom-0 w-full py-3 rounded-b-lg bg-cover bg-center"
                  style={{ backgroundImage: `url(${oceanOverlay.src})`, backgroundBlendMode: 'overlay', backgroundColor: 'rgba(0, 150, 136, 0.7)' }}
                >
                  Hotels
                </div>
