  ...
  return (
    <>
      ...
      <div className="max-w-7xl mx-auto  flex flex-col md:flex-row gap-4">
        ...
        <div className="w-[80%] mx-auto px-4 py-4 shadow-[0_0_10px_0_rgba(0,0,0,0.1)] rounded-md mb-10">
          ...
          <div className="mt-10 flex flex-col gap-4 overflow-y-auto">
            {airlineDetails.map((airline) => (
              <div className="flex items-center gap-4 w-full" key={airline.id}>
                <div
                  key={airline.id}
                ...
                >
                  <div className="flex flex-col md:flex-row justify-between items-start gap-6">
                    <div className="flex flex-col md:flex-row gap-4 items-start flex-1">
                      <div className="p-1 rounded-lg w-[7.6rem] flex items-center justify-center">
                      ...
                      <div className="flex flex-col gap-4 justify-between h-full w-[70%]">
                        ...
                        <div className="flex items-center gap-2 w-full">
                          ...
                          {/* Arrival */}
                          <div className="flex flex-col">
                            <div className="text-sm font-medium">22:45</div>
                            <div className="text-gray-700 font-medium text-xs">
                              DXB 18 JAN
                            </div>
                          </div>
                  ...
                  <div className="flex items-center justify-between gap-2 mt-4">
                    <Link
                      ...
                      className="border border-secondarycolor text-secondarycolor hover:bg-secondarycolor hover:text-white hover:border-none rounded-md px-4 py-3 font-medium text-xs w-[30%] text-center transition-all duration-300"
                    >
                      View details
                    </Link>
                    {/* Included items */}
